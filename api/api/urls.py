...
path('list_health/', views.list_health),
path('list_health/<int:switch_id>/', views.get_switch_health),
path('reservation_preflight/<int:switch_id>/', views.reservation_preflight),
